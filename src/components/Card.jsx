export default function Card(){
    return(
      <div className="card">
        <svg className="cloud" xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
        ...
        <div className="cardText">
          <p className='titleText'>Easy Deployment</p>
          <p className="descriptionText">Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</p>
        </div>
      </div>
    )
}